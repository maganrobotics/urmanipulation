...
gl_jaw_center_y = rm.rotmat_from_axangle((np.array([0,0,1])),math.pi/2).dot(np.array([1,0,0]))
print("the gl_jaw_center_z", gl_jaw_center_z)
print("the gl_jaw_center_y", gl_jaw_center_y)
grasp_info_list = gu.define_grasp(gripper_s, roller,
                                  gl_jaw_center_pos=np.array([0,0,-0.035]),
...
gu.write_pickle_file('roller', grasp_info_list, './', 'define_roller.pickle')
