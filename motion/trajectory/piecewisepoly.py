...
class PiecewisePoly(object):
    ...
    def _quintic_interpolate(self, A, samples_list):
        ...
        for i in range(n_sections):
            ...
            # print("interpolated_x_sec", interpolated_x_sec)
            # dimension_x = interpolated_x.shape
            # dimension_sec = interpolated_x_sec.shape
            # print("dimension_x", dimension_x)
            # print("dimension_sec", dimension_sec)
            #
            # # ===========================================
            interpolated_x += interpolated_x_sec.tolist()
            # print("interpolated %s", i, interpolated_x)
            # interpolated_x = interpolated_x + interpolated_x_sec
